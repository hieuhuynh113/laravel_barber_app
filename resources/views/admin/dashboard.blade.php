...
<div class="container-fluid py-4">
    ...
    <div class="tab-content" id="dashboardTabsContent">
        ...
        <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
            ...
            <!-- Doanh thu hôm nay và Đánh giá trung bình -->
            <div class="row mb-4">
...
<script>
    $(document).ready(function() {
        // Lấy tab đã lưu từ localStorage (nếu có)
        var activeTab = localStorage.getItem('admin_dashboard_active_tab');
        ...
        // Lưu tab được chọn vào localStorage khi người dùng chuyển tab
        $('#dashboardTabs button').on('shown.bs.tab', function (e) {
            var targetTab = $(e.target).data('bs-target');
            localStorage.setItem('admin_dashboard_active_tab', targetTab);
        });
    });
</script>
@endsection