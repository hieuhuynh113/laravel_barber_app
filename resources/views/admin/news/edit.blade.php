                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            @if($news->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $news->image) }}" alt="{{ $news->title }}" class="img-thumbnail" id="image-preview" style="max-height: 150px;">
                                </div>
                            @else
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status_published" value="1" {{ old('status', $news->status) == 1 ? 'checked' : '' }}>
                                <label class="form-check-label" for="status_published">
                                    Xuất bản
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status_draft" value="0" {{ old('status', $news->status) == 0 ? 'checked' : '' }}>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords', $news->meta_keywords) }}">
