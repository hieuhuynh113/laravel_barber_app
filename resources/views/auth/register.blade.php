                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('verification.send') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control password-validate @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control password-confirm" name="password_confirmation" required autocomplete="new-password" data-password-field="password">
                            </div>
                        </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary btn-lg w-100">
                                    {{ __('Tiếp tục') }} <i class="fas fa-arrow-right ms-1"></i>
                                </button>
                                <div class="mt-3 text-center">
                                    <small class="text-muted">Bạn sẽ nhận được mã OTP để xác thực email</small>
                                </div>
                            </div>
                        </div>
                    </form>
