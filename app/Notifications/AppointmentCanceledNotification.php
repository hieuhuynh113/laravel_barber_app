...
class AppointmentCanceledNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Lịch hẹn đã bị hủy bởi ' . $this->appointment->user->name)
            ->line('Lịch hẹn sau đã bị hủy bởi khách hàng:')
            ->line('Mã đặt lịch: ' . $this->appointment->booking_code)
            ->line('Khách hàng: ' . $this->appointment->customer_name)
            ...
            ->action('Xem chi tiết', url('/admin/appointments/' . $this->appointment->id))
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'services' => $services,
            'canceled_at' => now()->format('d/m/Y H:i'),
